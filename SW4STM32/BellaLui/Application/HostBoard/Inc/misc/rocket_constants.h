...
#define ROCKET_CST_LIFTOFF_TRIG_ACCEL 1.1 // acceleration lift-off detection trigger [g]
#define ROCKET_CST_MIN_TRIG_AGL 1 // min altitude above ground level to allow apogee detection [m]
#define ROCKET_CST_MOTOR_BURNTIME 1000 // motor burn time [ms]
#define ROCKET_CST_REC_SECONDARY_ALT 0.5 // altitude of secondary recovery event [m]
#define LIFTOFF_DETECTION_DELAY 10 // delay to trigger the liftoff event [ms]
