...
enum states
{
  ...
  STATE_CLOSE_PURGE_VALVE,
  STATE_OPEN_FILL_VALVE_BACKUP,
  STATE_CLOSE_FILL_VALVE_BACKUP,
  STATE_OPEN_PURGE_VALVE_BACKUP,
  STATE_CLOSE_PURGE_VALVE_BACKUP,
  STATE_CODE_CORRECT,
  STATE_CODE_INCORRECT,
  STATE_DISCONNECT_HOSE,
  STATE_IGNITION_ACTIVE,
  STATE_IGNITION_SEC_ACTIVE,
  STATE_LIFTOFF,
  STATE_COAST,
  STATE_PRIMARY,
  STATE_SECONDARY,
