...
enum DatagramPayloadType {
	GPS_PACKET = 0x01, STATUS_PACKET = 0x02, TELEMETRY_PACKET = 0x03, DEBUG_PACKET = 0x04, MOTOR_PACKET = 0x05, AIRBRAKES_PACKET = 0x06, ORDER_PACKET = 0x09, IGNITION_PACKET = 0x07, GSE_STATE_PACKET = 0x0A
};

enum  packetSize
{
	ORDER_PACKET_SIZE = 30, IGNITION_PACKET_SIZE = 30, TELEMETRY_PACKET_SIZE = 54
};
...
#define GSE_STATE_DATAGRAM_PAYLOAD_SIZE 29
