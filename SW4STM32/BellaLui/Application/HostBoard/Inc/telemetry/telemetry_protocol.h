...
enum DatagramPayloadType {
	GPS_PACKET = 0x01, STATUS_PACKET = 0x02, TELEMETRY_PACKET = 0x03, DEBUG_PACKET = 0x04, MOTOR_PACKET = 0x05, AIRBRAKES_PACKET = 0x06, ORDER_PACKET = 0x07, IGNITION_PACKET = 0x09, PROPULSION_COMMAND_PACKET = 0x0C, PROPULSION_DATA_PACKET = 0x0D
};
...
#define PROPULSION_DATAGRAM_PAYLOAD_SIZE 16
