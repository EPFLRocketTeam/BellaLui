...
enum DatagramPayloadType {
	GPS_PACKET = 0x01, STATUS_PACKET = 0x02, TELEMETRY_PACKET = 0x03, DEBUG_PACKET = 0x04, ORDER_PACKET = 0x05, AIRBRAKES_PACKET = 0x06, IGNITION_PACKET = 0x07, GSE_STATE_PACKET = 0x0A, MOTOR_PACKET = 0x0B
};
